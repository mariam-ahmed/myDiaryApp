...
import '../screens/therapist/patients_overview_screen.dart';

class TherapistNavBar extends StatelessWidget {
  String name = "";
  String uid = "";

  TherapistNavBar(this.name, this.uid, {super.key});
            ...
            onTap: () {
              ...
              FirebaseAuth.instance.signOut().then((value) {
                Navigator.push(context,
                    MaterialPageRoute(builder: (context) => PatientOverviewScreen(uid)));
              });
            },
          ),
          Divider(),
